...
PBEParameter.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "salt", univ.OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(8, 8))
    ),
...
PBKDF2_params.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "keyLength", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, MAX))
    ),
...
RC2_CBC_Parameter.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "iv", univ.OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(8, 8))
    ),
)
...
RC5_CBC_Parameters.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "rounds", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(8, 127))
    ),
    namedtype.NamedType(
        "blockSizeInBits",
