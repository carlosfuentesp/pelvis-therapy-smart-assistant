...
BuiltInStandardAttributes.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "network-address",
        NetworkAddress().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
    namedtype.OptionalNamedType(
        "terminal-identifier",
...
DirectoryString.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "utf8String", char.UTF8String().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, MAX))
    ),
    namedtype.NamedType(
        "bmpString", char.BMPString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, MAX))
    ),
)
...
EDIPartyName.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "nameAssigner",
        DirectoryString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
    namedtype.NamedType(
        "partyName",
...
DistributionPoint.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "reasons",
        ReasonFlags().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
    ),
    namedtype.OptionalNamedType(
        "cRLIssuer",
        GeneralNames().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2)),
    ),
)
...
AuthorityKeyIdentifier.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "keyIdentifier",
        KeyIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
    namedtype.OptionalNamedType(
        "authorityCertIssuer",
        GeneralNames().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
    ),
    namedtype.OptionalNamedType(
...
GeneralSubtree.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "maximum",
        BaseDistance().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
    ),
)
...
NameConstraints.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "permittedSubtrees",
        GeneralSubtrees().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
    namedtype.OptionalNamedType(
        "excludedSubtrees",
        GeneralSubtrees().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
    ),
)
...
DisplayText.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "ia5String", char.IA5String().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 200))
    ),
    namedtype.NamedType(
        "visibleString",
    ...
    namedtype.NamedType(
        "bmpString", char.BMPString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 200))
    ),
    namedtype.NamedType(
        "utf8String", char.UTF8String().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 200))
    ),
)
...
IssuingDistributionPoint.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "onlySomeReasons",
        ReasonFlags().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3)),
    ),
    namedtype.DefaultedNamedType(
        "indirectCRL",
        univ.Boolean()
