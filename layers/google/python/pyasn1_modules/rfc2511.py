...
class CertTemplate(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.OptionalNamedType(
            "version",
            Version().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
        ),
        namedtype.OptionalNamedType(
            "serialNumber",
        ...
        namedtype.OptionalNamedType(
            "issuer",
            Name().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 3)),
        ),
        namedtype.OptionalNamedType(
            "validity",
        ...
        namedtype.OptionalNamedType(
            "subject",
            Name().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 5)),
        ),
        namedtype.OptionalNamedType(
            "publicKey",
