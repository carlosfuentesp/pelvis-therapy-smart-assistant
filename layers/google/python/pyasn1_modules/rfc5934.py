...
TargetIdentifier.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "allModules",
        univ.Null().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3)),
    ),
    namedtype.NamedType(
        "uri",
        char.IA5String().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 4)),
    ),
    namedtype.NamedType(
        "otherName",
        AnotherName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 5)),
    ),
)
...
TBSCertificateChangeInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "issuer", Name().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "validity",
        Validity().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2)),
    ),
    namedtype.OptionalNamedType(
        "subject", Name().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
    ),
    namedtype.NamedType(
    ...
    namedtype.OptionalNamedType(
        "exts",
        Extensions().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 5)),
    ),
)
