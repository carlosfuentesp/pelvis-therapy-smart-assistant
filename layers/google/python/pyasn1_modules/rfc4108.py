...
PreferredPackageIdentifier.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "verNum", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, MAX))
    ),
)
...
FirmwarePackageInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "dependencies", univ.SequenceOf(componentType=PreferredOrLegacyPackageIdentifier())
    ),
)
