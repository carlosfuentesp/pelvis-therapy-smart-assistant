...
KeyPkgReceiver.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "sirEntity",
        SIREntityName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
    namedtype.NamedType(
        "community",
...
RegisterID.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "register",
        Register().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 5)),
    ),
    namedtype.NamedType(
        "registerRange",
...
SegmentID.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "segmentNumber",
        SegmentNumber().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 7)),
    ),
    namedtype.NamedType(
        "segmentRange",
...
KeyDistPeriod.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "doNotDistBefore",
        BinaryTime().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
...
KeyDuration.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "days",
        univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, ub_KeyDuration_days)),
    ),
    namedtype.NamedType(
        "weeks",
        univ.Integer()
