...
CertPathControls.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "certificate",
        Certificate().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
    namedtype.OptionalNamedType(
        "policySet",
    ...
    namedtype.OptionalNamedType(
        "policyFlags",
        CertPolicyFlags().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2)),
    ),
    namedtype.OptionalNamedType(
        "nameConstr",
        NameConstraints().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3)),
    ),
    namedtype.OptionalNamedType(
        "pathLenConstraint",
        univ.Integer()
...
TrustAnchorChoice.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "tbsCert",
        TBSCertificate().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
    ),
    namedtype.NamedType(
        "taInfo",
