    ...
    componentType = namedtype.NamedTypes(
        namedtype.DefaultedNamedType(
            ...
            univ.Boolean().subtype(
                value=0, implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)
            ),
        ),
        namedtype.DefaultedNamedType(
            "recipientsNotMutuallyAware",
            univ.Boolean().subtype(
                value=1, implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)
            ),
        ),
        namedtype.DefaultedNamedType(
            "duration",
            univ.Integer().subtype(
                value=0, implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2)
            ),
        ),
        namedtype.DefaultedNamedType(
            "generationCounter",
            univ.Integer().subtype(
                value=2, implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3)
            ),
        ),
