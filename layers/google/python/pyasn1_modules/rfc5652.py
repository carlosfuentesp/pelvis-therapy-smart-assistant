...
OtherKeyAttribute.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "keyAttr", univ.Any(), openType=opentype.OpenType("keyAttrId", otherKeyAttributesMap)
    ),
)
...
OtherCertificateFormat.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "otherCert", univ.Any(), openType=opentype.OpenType("otherCertFormat", otherCertFormatMap)
    ),
)
...
OriginatorInfo.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "certs",
        CertificateSet().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
    namedtype.OptionalNamedType(
        "crls",
...
OtherRecipientInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "oriValue", univ.Any(), openType=opentype.OpenType("oriType", otherRecipientInfoMap)
    ),
)
...
AuthenticatedData.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "authAttrs",
        AuthAttributes().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2)),
    ),
