...
ChallengeFormat.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "min", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, MAX))
    ),
    namedtype.NamedType(
        "max", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, MAX))
    ),
)
...
ResponseFormat.componentType = namedtype.NamedTypes(
    namedtype.NamedType("encoding", Encoding()),
    namedtype.NamedType(
        "length", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, MAX))
    ),
    namedtype.DefaultedNamedType("checkDigit", univ.Boolean().subtype(value=0)),
)
...
PINPolicy.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "pinKeyId",
        char.UTF8String().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
    namedtype.NamedType(
        "pinUsageMode",
        PINUsageMode().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
    ),
    namedtype.OptionalNamedType(
        "maxFailedAttempts",
        univ.Integer()
    ...
    namedtype.OptionalNamedType(
        "pinEncoding",
        Encoding().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 5)),
    ),
)
